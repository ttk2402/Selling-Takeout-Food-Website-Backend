...
import com.kientran.identity_service.client.CartDto;
import com.kientran.identity_service.client.CartServiceClient;
...
public class AccountServiceImpl implements AccountService {
    ...
    public ResAccountDto createAccount(AccountDto accountDto, Integer roleId) {
        ...
        if(listAc.isEmpty()) {
            ...
            if(role.getRole().equals("CUSTOMER") || role.getRole().equals("STAFF")) {
                //Call to create new cart for account by accountID
                CartDto cartDto = new CartDto(newAccount.getId());
